                ...
                <div class="card-header">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4 text-right">
                            <a href="{{ url('raport/'.$student->id.'/pts/print') }}" class="btn btn-outline-primary btn-sm">Raport Akademik UTS</a><br>
                            <a href="{{ url('raport/'.$student->id.'/1/print') }}" class="btn btn-outline-primary btn-sm">Raport Akademik</a><br>
                            <a href="{{ url('raport/'.$student->id.'/2/print') }}" class="btn btn-outline-primary btn-sm">Raport Pengasuhan</a><br>
                            <a href="{{ url('raport/'.$student->id.'/3/print') }}" class="btn btn-outline-primary btn-sm">Raport Diknas</a><br>
                            <a href="{{ url('raport/'.$student->id.'/rq/print') }}" class="btn btn-outline-primary btn-sm">Raport Quran</a><br>
                        </div>
                    </div>
                </div>
                {{-- <div class="card-header">

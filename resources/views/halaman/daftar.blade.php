                ...
                <div class="card">
                    <div class="card-body">
                        <div class="col-xl-8 offset-xl-2 col-lg-10 offset-lg-1 mb-5 mb-xl-0">
                            <form action="{{ route('ppdb.simpan',['step'=>1]) }}" method="POST">
                                @csrf
                            <div class="container-fluid d-flex align-items-center">
                                <div class="row">
                                    <div class="col-lg-12 col-md-12">
                                        ...
                                        <p class="mt-0 mb-5">
                                            Pilih sekolah dan tahun ajaran yang dituju! Isilah data dasar dibawah, tab lain seperti Profil Keluarga dan lain-lain akan aktif setelahnya. Isi selengkap-lengkapnya, lalu jangan lupa <b>Simpan</b>. Sistem akan mengakumulasi prosesnya. Jika sudah lengkap 100%, Anda akan terima email kembali.</p>
                                    </div>
                                    <div class="col-md-12">
                                        <div class="row form-group">
                                            <label class="col-md-4 col-form-label" for="sekolah">Pilih Sekolah {{-- <spanclass="text-red">*)</span> --}}</label>
                                            <div class="col-md-8">
                                    ...
                                    <div class="col-md-12">
                                        <div class="row form-group">
                                            <label class="col-md-4 col-form-label" for="tahun_ajar">Pilih Tahun Ajaran {{-- <spanclass="text-red">*)</span> --}}</label>
                                            <div class="col-md-8">
                                                <select name="academic_year_id" id="academic_year_id" class="form-control" onchange="gantitahunajaran()" required>
                                ...
                                <div class="card-body">
                                    <div class="tab-content" id="myTabContent">
                                        <div class="tab-pane fade show active" id="tabs-icons-text-1" role="tabpanel" aria-labelledby="tabs-icons-text-1-tab">
                                            @include('halaman.dalam.person-standard')
                                            </form>
                                        </div>
                                                                ...
                                                                <tfoot>
                                                                    <tr>
                                                                        ...
                                                                        <th scope="col" class="sort" data-sort="year">
                                                                            <input type="number" name="year-prestasi" id="year-prestasi" class="form-control form-block form-control-sm"></th>
                                                                        <th scope="col" class="sort" data-sort="desc">
                                                                            <input type="text" name="desc-prestasi" id="des-prestasi" class="form-control form-block form-control-sm"></th>
                                                                        <th scope="col">

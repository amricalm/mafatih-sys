            ...
            <div class="row">
                ...
                <div class="col-lg-6 text-right">
                    <div class="btn-group" role="group" aria-label="Basic example">
                        <a href="{{ route('studentpassed') }}" class="btn btn-sm btn-neutral"><i class="fa fa-arrows"></i> Proses</a>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="card-body row">
                    <div class="col-md-12">
                        <div class="form-group row">
                            <label for="staticEmail" class="col-sm-2 col-form-label">Tahun Kelulusan</label>
                            <div class="col-sm-10">
...
<script type="text/javascript">
    ...
    {
        $('#bodytable').html('');
        $.get('{{ url('alumni') }}/'+id+'/show',function(data){
            $('#bodytable').html(data);
            $('#btnExport').show();
        })
    }

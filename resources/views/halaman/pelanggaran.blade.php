                    ...
                    <div class="col-lg-6">
                        <nav aria-label="breadcrumb" class="d-none d-md-inline-block">
                            <ol class="breadcrumb breadcrumb-links breadcrumb-dark">
                                ...
                                <li class="breadcrumb-item active" aria-current="page"><a href="#">Daftar Pelanggaran</a></li>
                            </ol>
                        </nav>
                    </div>
                    <div class="col-lg-6 text-right">
                        <div class="btn-group" role="group" aria-label="Basic example">
                            <a href="{{ route('tambah-siswa') }}" class="btn btn-sm btn-neutral"><i class="fas fa-plus"></i> Tambah Pelanggaran</a>
                          </div>
                    </div>
                </div>
            </div>
                    ...
                    <table class="table align-items-center">
                        <thead class="thead-light">
                            <tr>
                                ...
                                <th scope="col" class="sort" data-sort="budget">Nama Pelanggaran</th>
                                <th scope="col"></th>
                            </tr>
                        </thead>
                        <tbody class="list">
                            @php
                                ...
                                $list = [
                                    [
                                        'foto' => $foto[0],
                                        'namalengkap' => 'khdrn',
                                        'ttl' => 'Kehadiran dan Keterlambatan',
                                    ...
                                    [
                                        'foto' => $foto[0],
                                        'namalengkap' => 'pribadi',
                                        'ttl' => 'Pakaian dan Peralatan/Kepribadian',

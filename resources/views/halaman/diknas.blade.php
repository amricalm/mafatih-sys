        ...
        <div class="col-md-12">
            <div class="card-deck">
                @php
                    $arraymenu = [
                        [
                            'name' => 'Mata Pelajaran Diknas',
                            'desc' => 'Setting Mata Pelajaran Diknas',
                            'url' => 'diknas/matapelajaran',
                        ],
                        [
                            'name' => 'Grup Mata Pelajaran Diknas',
                            'desc' => 'Pemetaan Grup Mata Pelajaran Diknas',
                            'url' => 'diknas/pemetaan',
                        ]
                        ,
                        [
                            'name' => 'Kompetensi Dasar',
                            'desc' => 'Setting Kompetensi Inti & Kompetensi Dasar Kurikulum 2013',
                            'url' => 'diknas/kompetensi',
                        ]
                    ];
                @endphp

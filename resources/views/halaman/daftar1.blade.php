                                                ...
                                                <div class="row mt-3">
                                                    <div class="col-md-12">
                                                        <div class="form-group input-group-sm">
                                                            ...
                                                            <input type="text" name="nisn" id="nisn" class="form-control" autocomplete="off">
                                                        </div>
                                                    </div>
                                                    <div class="col-md-6">
                                                        <div class="form-group input-group-sm">
                                                            <label class="form-control-label" for="nisn">Nama Lengkap</label>
                                                            <input type="text" name="name" id="nisn" class="form-control" autocomplete="off" required>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-6">
                                                        <div class="form-group input-group-sm">
                                                    ...
                                                    <div class="col-md-12">
                                                        <div class="form-group input-group-sm">
                                                            ...
                                                            <input type="text" class="form-control arabic" name="name_ar" id="name_ar" autocomplete="off" dir="rtl" required>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-6">
                                                        <div class="form-group input-group-sm">
                                                            <label class="form-control-label" for="pob">Tempat Lahir</label>
                                                            <input type="text" class="form-control" name="pob" autocomplete="off" required>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-6">
                                                        <div class="form-group input-group-sm">
                                                            <label class="form-control-label" for="dob">Tanggal Lahir</label>
                                                            <input type="text" class="form-control datepicker" name="dob" autocomplete="off" required>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-6">
                                                        <div class="form-group input-group-sm">
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group input-group-sm">
                                                            ...
                                                            <input type="text" class="form-control" name="son_order" id="son_order" autocomplete="off" required>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-6">
                                                        <div class="form-group input-group-sm">

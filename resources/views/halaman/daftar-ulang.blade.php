...
<div class="container">
  <div class="py-5 text-center">
    <img class="d-block mx-auto mb-4" src="http://2.bp.blogspot.com/-yhNDG3gL6hg/VNGRykRbmII/AAAAAAAAAq8/sNDt1ChdEmg/s400/Logo%2BAl%2BHamid%2BBARU.jpg" alt="" width="72" height="72">
    <h2>Formulir Daftar Ulang</h2>
    <p class="lead">Mohon diperhatikan isian dibawah ini.</p>
  </div>

  <div class="row">
    <div class="col-md-4 order-md-1 mb-4">
      <h4 class="d-flex justify-content-between align-items-center mb-3">
        <span class="text-muted">Data Anak</span>
      ...
      <ul class="list-group mb-3">
        <li class="list-group-item d-flex justify-content-between lh-condensed">
          <div>
            ...
            <small class="text-muted">Muhammad Arifianto</small>
          </div>
        ...
        <li class="list-group-item d-flex justify-content-between lh-condensed">
          <div>
            ...
            <small class="text-muted">Jalan H. Jeran No. 23225 Jakarta</small>
          </div>
          {{-- <span class="text-muted">$8</span> --}}
        </li>
        <li class="list-group-item d-flex justify-content-between lh-condensed">
          <div>
            <h6 class="my-0">Sekolah Asal</h6>
            <small class="text-muted">TK Asli Jakarta</small>
          </div>
          {{-- <span class="text-muted">$5</span> --}}
        </li>
        <li class="list-group-item d-flex justify-content-between bg-light">
          <div class="text-success">
            <h6 class="my-0">Tanggal Daftar</h6>
    ...
    <div class="col-md-8 order-md-2">
      <h4 class="mb-3">Isi Data yang benar</h4>
  ...
  <footer class="my-5 pt-5 text-muted text-center text-small">
    <p class="mb-1">&copy; 2022 Alhamid</p>

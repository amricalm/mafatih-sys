                ...
                <div class="card-header border-0">
                    <div class="row align-items-center">
                        ...
                        <div class="col-md-6 text-right input-group-sm">
                            <select class="form-control select2" id="classes" name="classes" required>
                                <option>- Pilih Musyrif Sakan -</option>
    ...
    $(function() {
        ...
        $(document).ready(function() {
            ...
            $("#cari").submit(function(e) {
                e.preventDefault();
                $.ajax({
                    url: "{{ route('outside.boardinggroup') }}",
                    type: 'post',
                    data: $(this).serialize(),
            ...
            $('#classes').bind('change', function(e) {
                ...
                $.ajax({
                    url: "{{ route('inside.boardinggroup') }}",
                    type: "POST",
                    data: {
                        ccid: ccid
                    },

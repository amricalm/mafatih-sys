                ...
                <div class="col-lg-6">
                    <nav aria-label="breadcrumb" class="d-none d-md-inline-block">
                        <ol class="breadcrumb breadcrumb-links breadcrumb-dark">
                            ...
                            <li class="breadcrumb-item active" aria-current="page"><a href="#">{{ __('Detail Siswa') }}</a>
                            </li>
                        </ol>
                    </nav>
                </div>
            ...
            <div class="card">
                <div class="card-header">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="jumbotron">
                                <h1 class="display-4">{{ $person->name }} / {{ $person->name_ar }}</h1>
                                <p style="margin-bottom:0px;">Kelas Akademik : <b>{{ $kelas['name'] }} / <span class="arabic">{{ $kelas['name_ar'] }}</span> / LEVEL {{ $kelas['level'] }}</b></p>
                                <p style="margin-bottom:0px;">Walikelas Akademik : <b>{{ ($walikelas['sex']=='L' ? 'Ustadz':'Ustadzah') }} {{ $walikelas['name'] }} / <span class="arabic">{{ \App\SmartSystem\General::ustadz($walikelas['sex']) }} {{ $walikelas['name_ar'] }}</span></b></p>
                                <p style="margin-bottom:0px;">Kelas Pengasuhan : <b>{{ ($pengasuhan['sex']=='L' ? 'Ustadz':'Ustadzah') }} {{ $pengasuhan['name'] }} / <span class="arabic">{{ \App\SmartSystem\General::ustadz($pengasuhan['sex']) }} {{ $pengasuhan['name_ar'] }}</span></b></p>
                                @php
                                    if(count($bayanat)==0)
                                    {
                                ...
                                @endphp
                                <p style="margin-bottom:0px;">Kelas Bayanat Quran : <b>{{ $bayanat['teachername'] }} / <span class="arabic">{{ $bayanat['classname'] }} / {{ $bayanat['level'] }}</span></b></p>
                            </div>
                        </div>
                    </div>
                </div>

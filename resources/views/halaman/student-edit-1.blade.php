                ...
                <div class="col-lg-6">
                    <nav aria-label="breadcrumb" class="d-none d-md-inline-block">
                        <ol class="breadcrumb breadcrumb-links breadcrumb-dark">
                            ...
                            <li class="breadcrumb-item active" aria-current="page"><a href="#">{{ __('Tambah Siswa') }}</a></li>
                        </ol>
                    </nav>
                </div>
                        ...
                        <div class="col-xl-8 offset-xl-2 col-lg-10 offset-lg-1 mb-5 mb-xl-0">
                            <div class="nav-wrapper">
                                <ul class="nav nav-pills flex-column flex-md-row" id="tabs-icons-text" role="tablist">
                                    <li class="nav-item">
                                        <a class="nav-link mb-sm-3 mb-md-0 active" id="tabs-icons-text-1-tab" data-toggle="tab" href="#tabs-icons-text-1" role="tab" aria-controls="tabs-icons-text-1" aria-selected="true">Profil Siswa</a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link mb-sm-3 mb-md-0" id="tabs-icons-text-2-tab" data-toggle="tab" href="#tabs-icons-text-2" role="tab" aria-controls="tabs-icons-text-2" aria-selected="false">Profil Keluarga</a>
                                    </li>
                                    <li class="nav-item">
                                ...
                                <div class="card-body">
                                    <div class="tab-content" id="myTabContent">
                                        <div class="tab-pane fade show active" id="tabs-icons-text-1" role="tabpanel" aria-labelledby="tabs-icons-text-1-tab">
                                            <form action="{{ route('siswa.update',['step'=>1]) }}" method="POST">
                                                @csrf
                                                ...
                                                <div class="row">
                                                    <div class="col-md-12">
                                                        <div class="form-group input-group-sm">
                                                            ...
                                                            <input type="text" name="nis" id="nis" class="form-control" autocomplete="off" placeholder="Nomor Induk Siswa" value="{{ $siswa->nis }}">
                                                        </div>
                                                    </div>
                                                    <div class="col-md-12">
                                                        <div class="form-group input-group-sm">
                                                            <label class="form-control-label" for="nisn">NISN</label>
                                                            <input type="text" name="nisn" id="nisn" class="form-control" autocomplete="off" placeholder="Nomor Induk Siswa Nasional" value="{{ $siswa->nisn }}">
                                                        </div>
                                                    </div>
                                                    <div class="col-md-6">
                                                        <div class="form-group input-group-sm">
                                                            <label class="form-control-label" for="name">Nama Lengkap</label>
                                                            <input type="text" name="name" id="name" class="form-control" autocomplete="off" placeholder="Nama Lengkap" required value="{{ $person->name }}">
                                                        </div>
                                                    </div>
                                                    <div class="col-md-6">
                                                        <div class="form-group input-group-sm">
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group input-group-sm">
                                                            ...
                                                            <input type="text" class="form-control datepicker" name="dob" autocomplete="off" required placeholder="1999-09-19" value="{{ $person->dob }}">
                                                        </div>
                                                    </div>
                                                    <div class="col-md-6">
                                                        <div class="form-group input-group-sm">
                                                            ...
                                                            $i++;
                                                            echo '<input type="radio" name="sex" id="sex'.$i.'" value="'.$key.'" required '.(($person->sex==$key) ? ' checked':'').'> <label for="sex'.$i.'">'.$val.'</label>&nbsp;&nbsp;';
                                                            }
                                                            @endphp
                                                        </div>
                                                    </div>
                                                    <div class="col-md-6">
                                                        <div class="form-group input-group-sm">
                                                            ...
                                                            <input type="text" class="form-control" name="son_order" id="son_order" autocomplete="off" value="{{ $person->son_order }}">
                                                        </div>
                                                    </div>
                                                    <div class="col-md-6">
                                                        <div class="form-group input-group-sm">
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group input-group-sm">
                                                            ...
                                                            <select name="religion" id="religion" class="form-control">
                                                                ...
                                                                {
                                                                echo '<option value="'.$key.'" '.(($person->religion==$key)?' selected="selected"':'').'>'.$val.'</option>';
                                                                }
                                                                @endphp
                                                            </select>
                                                        </div>
                                                    ...
                                                    <div class="col-md-6">
                                                        ...
                                                        <div class="form-group input-group-sm">
                                                            ...
                                                            <select class="form-control" name="kota" id="kota" required>
                                                                ...
                                                                <option value="{{ $key ?? '' }}" {!! (($alamat->city==$key)?'selected="selected"':'') !!}>{{ $val }}</option>
                                                                @endforeach
                                                            </select>
                                                        </div>
                                                        <div class="form-group input-group-sm">
                                                            ...
                                                            <select class="form-control" name="kecamatan" id="kecamatan" required>
                                                                ...
                                                                <option value="{{ $key ?? '' }}" {!! (($alamat->district==$key)?'selected="selected"':'') !!}>{{ $val }}</option>
                                                                @endforeach
                                                            </select>
                                                        </div>
                                                        <div class="form-group input-group-sm">
                                                            ...
                                                            <select class="form-control" name="desa" id="desa" required>
                                                                ...
                                                                <option value="{{ $key ?? '' }}" {!! (($alamat->village==$key)?'selected="selected"':'') !!}>{{ $val }}</option>
                                                                @endforeach
                                                            </select>
                                                        </div>
                                                        <div class="form-group input-group-sm">

                                            ...
                                            <div class="col">
                                                <div class="form-group">
                                                    <div class="input-group">
                                                        ...
                                                        <input class="form-control" name="tgl_awal" placeholder="Tanggal Awal" type="text" value="{{ date('Y-m-d') }}">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col">
                                                <div class="form-group">
                                                    <div class="input-group">
                                                        ...
                                                        <input class="form-control" name="tgl_akhir" placeholder="Tanggal Akhir" type="text" value="{{ date('Y-m-d') }}">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>

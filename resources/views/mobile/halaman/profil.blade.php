        ...
        <div class="container mb-4">
            <ul class="nav justify-content-center row mb-2">
                <li class="col-6 nav-item mb-2">
                    <button class="btn btn-outline-default px-2 btn-block rounded" id="home-tab" data-toggle="tab" href="#home" role="tab"  aria-controls="home" aria-selected="true"><span class="material-icons mr-1">contact_mail</span> Siswa</button>
                </li>
                <li class="col-6 nav-item mb-2">
                    <button class="btn btn-outline-default px-2 btn-block rounded" id="profile-tab" data-toggle="tab" href="#profile" role="tab"  aria-controls="profile" aria-selected="false"><span class="material-icons mr-1">recent_actors</span> Keluarga</button>
                </li>
                <li class="col-6 nav-item mb-2">
                    <button class="btn btn-outline-default px-2 btn-block rounded" id="messages-tab" data-toggle="tab" href="#messages" role="tab"  aria-controls="messages" aria-selected="false"><span class="material-icons mr-1">badge</span> Profil Lain</button>
                </li>
                <li class="col-6 nav-item mb-2">
                    <button class="btn btn-outline-default px-2 btn-block rounded" id="settings-tab" data-toggle="tab" href="#settings" role="tab"  aria-controls="settings" aria-selected="false"><span class="material-icons mr-1">foundation</span> Sekolah Asal</button>
                </li>
                <li class="col-6 nav-item mb-2">
                    <button class="btn btn-outline-default px-2 btn-block rounded" id="uploads-tab" data-toggle="tab" href="#uploads" role="tab"  aria-controls="uploads" aria-selected="false"><span class="material-icons mr-1">file_upload</span> Upload</button>
                </li>
            </ul>
        </div>
        <div class="container">
            <div class="tab-content">
                    ...
                    <div class="card">
                        <div class="card-header border-0">
                            <div class="row">
                                <div class="col align-self-center">
                                    <h6 class="float-left">Profil Siswa</h6>
                                </div>
                                <div class="col-6">
                                    <div class=" float-right">
                                        <span class="material-icons mr-1">contact_mail</span>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="card-body">
                            <form id="formstep1">
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group input-group-sm active">
                                            <label class="form-control-label" for="nis">NIS <small>(diisi sekolah)</small></label>
                                            <input type="text" name="nis" id="nis" class="form-control bg-secondary text-white" autocomplete="off" disabled="disabled" value="{{ $student->nis }}" readonly>
                                            <input type="hidden" name="nis" value="{{ $student->nis }}">
                                        </div>
                                    </div>
                                    <div class="col-md-12">
                                        <div class="form-group input-group-sm">
                                            <label class="form-control-label" for="nisn">NISN <small>(diisi sekolah)</small></label>
                                            <input type="text" name="nisn" id="nisn" class="form-control bg-secondary text-white" autocomplete="off" disabled="disabled" value="{{ $student->nisn }}" readonly>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group input-group-sm">
                                            ...
                                            <input type="text" name="nickname" id="nickname" class="form-control" autocomplete="off" placeholder="Nama Panggilan" value="{{ $person->nickname }}">
                                        </div>
                                    </div>
                                    <div class="col-md-12">
                                        <div class="form-group input-group-sm">
                                            <label class="form-control-label" for="name_ar">Nama Lengkap Dalam Huruf Arab</label>
                                            <input type="text" class="form-control arabic" name="name_ar" id="name_ar" autocomplete="off" dir="rtl" placeholder="بالعربية" required value="{{ $person->name_ar }}">
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-group input-group-sm">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group input-group-sm">
                                            ...
                                            <input type="text" class="form-control" name="pob" autocomplete="off" required placeholder="Tempat Lahir" value="{{ $person->pob }}">
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group input-group-sm">
                                            <label class="form-control-label" for="dob">Tanggal Lahir</label>
                                            <input type="date" class="form-control" name="dob" autocomplete="off" required placeholder="1999-09-19" value="{{ $person->dob }}">
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group input-group-sm">
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group input-group-sm text-right">
                                            {{-- <button type="submit" class="btn btn-block btn-default rounded"><i class="fa fa-save"></i> Simpan</button> --}}
                                        </div>
                                    </div>
                                </div>
                            </form>
                ...
                <div class="tab-pane" id="profile" role="tabpanel" aria-labelledby="profile-tab">
                    <div class="card">
                        <div class="card-header border-0">
                            <div class="row">
                                <div class="col align-self-center">
                                    <h6 class="float-left">Profil Keluarga</h6>
                                </div>
                                <div class="col-6">
                                    <div class=" float-right">
                                        <span class="material-icons mr-1">recent_actors</span>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <form id="formstep2">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-group input-group-sm">
                                            <label class="form-control-label" for="ayah_dob">Tanggal Lahir Ayah</label>
                                            <input type="date" class="form-control datepicker" name="ayah_dob" id="ayah_dob" autocomplete="off" placeholder="1999-09-19" value="{{ ($person->ayah_id!='0'&&$person->ayah_id!='') ? $ayah->dob : '' }}" required>
                                        </div>
                                        <div class="form-group input-group-sm">
                                ...
                                <div class="ortu row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group input-group-sm">
                                            ...
                                            <select class="form-control" name="ayah_provinsi" id="ayah_provinsi" required>
                                ...
                                <div class="col-md-12 p-3 text-center">
                                    <div class="custom-control custom-checkbox">
                                        <input type="checkbox" class="custom-control-input" name="stay_with_wali" id="stay_with_wali" {{ !empty($person->wali_id) ? 'checked="checked"' : '' }}>
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group input-group-sm text-right">
                                            <button type="submit" class="btn btn-block btn-default rounded" id="btnStep2"><i class="fa fa-save"></i> Simpan</button>
                                        </div>
                                    </div>
                                </div>
                            </form>
                                    ...
                                    <form id="frmSaudara">
                                        ...
                                        <div class="row card-body">
                                            ...
                                            <div class="col-md-12 text-right">
                                                <button type="button" id="btnSimpanSaudara" class="btn btn-block btn-default rounded"><i class="fa fa-plus"></i> Tambah</button>
                                            </div>
                                        </div>
                                    </form>
                                </div>
                ...
                <div class="tab-pane" id="messages" role="tabpanel" aria-labelledby="messages-tab">
                    <div class="card">
                        <div class="card-header border-0">
                            <div class="row">
                                <div class="col align-self-center">
                                    <h6 class="float-left">Profil Lain</h6>
                                </div>
                                <div class="col-6">
                                    <div class=" float-right">
                                        <span class="material-icons mr-1">badge</span>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="card-body">
                            <form id="formstep3">
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group input-group-sm text-right">
                                            <button type="button" class="btn btn-block btn-default rounded" id="btnStep3"><i class="fa fa-save"></i> Simpan</button>
                                        </div>
                                    </div>
                                </div>
                            </form>
                                    ...
                                    <div class="col-md-12" style="border:1px solid black;border-radius:5px;padding:5px;">
                                        ...
                                        <form id="frmPrestasi">
                                            ...
                                            <div class="row card-body">
                                                ...
                                                <div class="col-md-12 text-right">
                                                    <button type="button" id="btnSimpanPrestasi" class="btn btn-block btn-default rounded"><i class="fa fa-plus"></i> Tambah</button>
                                                </div>
                                            </div>
                                        </form>
                                    </div>
                                    ...
                                    <div class="col-md-12" style="border:1px solid black;border-radius:5px;padding:5px;">
                                        ...
                                        <form id="frmSakit">
                                            ...
                                            <div class="row card-body">
                                                ...
                                                <div class="col-md-12 text-right">
                                                    <button type="button" id="btnSimpanSakit" class="btn btn-block btn-default rounded"><i class="fa fa-plus"></i> Tambah</button>
                                                </div>
                                            </div>
                                        </form>
                                    </div>
                ...
                <div class="tab-pane" id="settings" role="tabpanel" aria-labelledby="settings-tab">
                    <div class="card">
                        <div class="card-header border-0">
                            <div class="row">
                                <div class="col align-self-center">
                                    <h6 class="float-left">Sekolah Asal</h6>
                                </div>
                                <div class="col-6">
                                    <div class=" float-right">
                                        <span class="material-icons mr-1">foundation</span>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="card-body">
                            <form id="formstep6">
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group input-group-sm text-right">
                                            <button type="button" class="btn btn-block btn-default rounded" id="btnStep6"><i class="fa fa-save"></i> Simpan</button>
                                        </div>
                                    </div>
                                </div>
                            </form>
                ...
                <div class="tab-pane" id="uploads" role="tabpanel" aria-labelledby="uploads-tab">
                    <div class="card">
                        <div class="card-header border-0">
                            <div class="row">
                                <div class="col align-self-center">
                                    <h6 class="float-left">Upload</h6>
                                </div>
                                <div class="col-6">
                                    <div class=" float-right">
                                                ...
                                                @foreach($files as $key=>$val)
                                                    @if($val['desc']=='Foto Personal')
                                                        <div class="alert alert-light alert-dismissible fade show" role="alert">
                                                            ...
                                                            <a href="{{ asset('uploads/'.$val['url']); }}" target="_blank"><img src="{{ asset('uploads/'.$val['url']); }}" alt="Foto Personal" style="width:100%;height:200px"></a>
            ...
            <div class="card">
                ...
                {{-- <div class="card-footer">
                    <button class="btn btn-block btn-default rounded"><i class="fa fa-save"></i> Simpan</button>
                </div> --}}
            </div>
        </div>
    </div>
        ...
        $.ajax({
            ...
            success: function(data){
                ...
                if(datas[0]=='Berhasil')
                {
                    ...
                    {
                        text = '<div class="alert alert-light alert-dismissible fade show" role="alert" ><input type="hidden" id="'+tipe+'_desc" value="'+datas[3]+'"><a href="{{ url('/') }}/'+datas[2]+'" target="_blank"><img src="{{ url('/') }}/'+datas[2]+'" alt="'+datas[3]+'" style="width:100%;height:200px"></a><button type="button" class="close" aria-label="Close" onclick="hapusfile('+"'"+tipe+"'"+')"><span aria-hidden="true">&times;</span></button></div>';
                        $('#frmUpload'+tipe).html(text);
                    }
                    else
                    {
                        text = '<div class="alert alert-light alert-dismissible fade show" role="alert" ><input type="hidden" id="'+tipe+'_desc" value="'+datas[3]+'"><a href="{{ url('/') }}/'+datas[2]+'" target="_blank"><i></i> File </a><button type="button" class="close" aria-label="Close" onclick="hapusfile('+"'"+tipe+"'"+')"><span aria-hidden="true">&times;</span></button></div>';
                        $('#frmUpload'+tipe).html(text);
                    }

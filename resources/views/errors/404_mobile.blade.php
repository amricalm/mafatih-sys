...
<head>
    ...
    <link href="{{ asset('mobile') }}/css/style-maroon.css" rel="stylesheet" id="style">
    <link href="{{ asset('mobile') }}/css/style-custom.css" rel="stylesheet" id="style">
    <link type="text/css" href="{{ asset('assets') }}/css/app.css" rel="stylesheet">
</head>

<body style="background-image:url({{ asset('assets/img/adn/bg-msh-miring.png') }});-webkit-background-size: auto;-moz-background-size: cover;-o-background-size: cover;background-size: cover;background-position: center middle;background-origin: content-box;">

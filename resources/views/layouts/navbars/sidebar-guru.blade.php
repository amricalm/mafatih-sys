<nav class="navbar navbar-vertical fixed-left navbar-expand-md navbar-dark bg-maroon" id="sidenav-main">
    <div class="container-fluid">
        <!-- Toggler -->
        <button class="navbar-toggler" type="button" app-toggle="collapse" app-target="#sidenav-collapse-main"
        ...
        <ul class="nav align-items-center d-md-none">
            <li class="nav-item dropdown">
                <a class="nav-link" href="#" role="button" app-toggle="dropdown" aria-haspopup="true"
                    aria-expanded="false">
        ...
        <div class="collapse navbar-collapse" id="sidenav-collapse-main">
            ...
            <div class="navbar-collapse-header d-md-none">
                <div class="row">
                    ...
                    <div class="col-6 collapse-close">
                        <button type="button" class="navbar-toggler" app-toggle="collapse"
                            app-target="#sidenav-collapse-main" aria-controls="sidenav-main" aria-expanded="false"
            ...
            <div class="btn-group btn-block" role="group" aria-label="" style="margin-bottom:5px;"
                onclick="showabsenmodal()">
            ...
            <ul class="navbar-nav">
                ...
                for($i=0;$i<count($menu);$i++) { echo '<li class="nav-item">' ; echo '<a class="nav-link '
                    .((isset($aktif)&&$aktif==$menu[$i]['url']) ? ' active' : '' ).'" href="'.url($menu[$i]['url']).'"
